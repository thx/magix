...
*/
KISSY.add('magix', function (S, SE, DOM, SNode) {
 ...
 */
    ...
    Magix['$|_attrForTest_|$priFun$|_attrForTest_|$']={'set-G_GetAttribute':function(fun){ var ori=G_GetAttribute;G_GetAttribute=fun; return ori;},'get-G_GetAttribute':function(){ return G_GetAttribute;},'set-G_NOOP':function(fun){ var ori=G_NOOP;G_NOOP=fun; return ori;},'get-G_NOOP':function(){ return G_NOOP;},'set-G_Id':function(fun){ var ori=G_Id;G_Id=fun; return ori;},'get-G_Id':function(){ return G_Id;},'set-G_GetById':function(fun){ var ori=G_GetById;G_GetById=fun; return ori;},'get-G_GetById':function(){ return G_GetById;},'set-G_IsPrimitive':function(fun){ var ori=G_IsPrimitive;G_IsPrimitive=fun; return ori;},'get-G_IsPrimitive':function(){ return G_IsPrimitive;},'set-G_Set':function(fun){ var ori=G_Set;G_Set=fun; return ori;},'get-G_Set':function(){ return G_Set;},'set-G_NodeIn':function(fun){ var ori=G_NodeIn;G_NodeIn=fun; return ori;},'get-G_NodeIn':function(){ return G_NodeIn;},'set-G_Assign':function(fun){ var ori=G_Assign;G_Assign=fun; return ori;},'get-G_Assign':function(){ return G_Assign;},'set-G_Keys':function(fun){ var ori=G_Keys;G_Keys=fun; return ori;},'get-G_Keys':function(){ return G_Keys;},'set-View_ApplyStyle':function(fun){ var ori=View_ApplyStyle;View_ApplyStyle=fun; return ori;},'get-View_ApplyStyle':function(){ return View_ApplyStyle;},'set-IdIt':function(fun){ var ori=IdIt;IdIt=fun; return ori;},'get-IdIt':function(){ return IdIt;},'set-G_ToTry':function(fun){ var ori=G_ToTry;G_ToTry=fun; return ori;},'get-G_ToTry':function(){ return G_ToTry;},'set-G_Has':function(fun){ var ori=G_Has;G_Has=fun; return ori;},'get-G_Has':function(){ return G_Has;},'set-G_TranslateData':function(fun){ var ori=G_TranslateData;G_TranslateData=fun; return ori;},'get-G_TranslateData':function(){ return G_TranslateData;},'set-Magix_CacheSort':function(fun){ var ori=Magix_CacheSort;Magix_CacheSort=fun; return ori;},'get-Magix_CacheSort':function(){ return Magix_CacheSort;},'set-G_Cache':function(fun){ var ori=G_Cache;G_Cache=fun; return ori;},'get-G_Cache':function(){ return G_Cache;},'set-G_Require':function(fun){ var ori=G_Require;G_Require=fun; return ori;},'get-G_Require':function(){ return G_Require;},'set-G_DOMGlobalProcessor':function(fun){ var ori=G_DOMGlobalProcessor;G_DOMGlobalProcessor=fun; return ori;},'get-G_DOMGlobalProcessor':function(){ return G_DOMGlobalProcessor;},'set-G_DOMEventLibBind':function(fun){ var ori=G_DOMEventLibBind;G_DOMEventLibBind=fun; return ori;},'get-G_DOMEventLibBind':function(){ return G_DOMEventLibBind;},'set-Safeguard':function(fun){ var ori=Safeguard;Safeguard=fun; return ori;},'get-Safeguard':function(){ return Safeguard;},'set-Magix_ParamsFn':function(fun){ var ori=Magix_ParamsFn;Magix_ParamsFn=fun; return ori;},'get-Magix_ParamsFn':function(){ return Magix_ParamsFn;},'set-G_ParseUri':function(fun){ var ori=G_ParseUri;G_ParseUri=fun; return ori;},'get-G_ParseUri':function(){ return G_ParseUri;},'set-G_ToUri':function(fun){ var ori=G_ToUri;G_ToUri=fun; return ori;},'get-G_ToUri':function(){ return G_ToUri;},'set-G_ToMap':function(fun){ var ori=G_ToMap;G_ToMap=fun; return ori;},'get-G_ToMap':function(){ return G_ToMap;},'set-G_ParseExpr':function(fun){ var ori=G_ParseExpr;G_ParseExpr=fun; return ori;},'get-G_ParseExpr':function(){ return G_ParseExpr;},'set-StartCall':function(fun){ var ori=StartCall;StartCall=fun; return ori;},'get-StartCall':function(){ return StartCall;},'set-CallFunction':function(fun){ var ori=CallFunction;CallFunction=fun; return ori;},'get-CallFunction':function(){ return CallFunction;},'set-Mark':function(fun){ var ori=Mark;Mark=fun; return ori;},'get-Mark':function(){ return Mark;},'set-Unmark':function(fun){ var ori=Unmark;Unmark=fun; return ori;},'get-Unmark':function(){ return Unmark;},'set-DispatchEvent':function(fun){ var ori=DispatchEvent;DispatchEvent=fun; return ori;},'get-DispatchEvent':function(){ return DispatchEvent;},'set-State_IsObserveChanged':function(fun){ var ori=State_IsObserveChanged;State_IsObserveChanged=fun; return ori;},'get-State_IsObserveChanged':function(){ return State_IsObserveChanged;},'set-SetupKeysRef':function(fun){ var ori=SetupKeysRef;SetupKeysRef=fun; return ori;},'get-SetupKeysRef':function(){ return SetupKeysRef;},'set-TeardownKeysRef':function(fun){ var ori=TeardownKeysRef;TeardownKeysRef=fun; return ori;},'get-TeardownKeysRef':function(){ return TeardownKeysRef;},'set-GetParam':function(fun){ var ori=GetParam;GetParam=fun; return ori;},'get-GetParam':function(){ return GetParam;},'set-Router_UpdateHash':function(fun){ var ori=Router_UpdateHash;Router_UpdateHash=fun; return ori;},'get-Router_UpdateHash':function(){ return Router_UpdateHash;},'set-Router_Update':function(fun){ var ori=Router_Update;Router_Update=fun; return ori;},'get-Router_Update':function(){ return Router_Update;},'set-Router_Bind':function(fun){ var ori=Router_Bind;Router_Bind=fun; return ori;},'get-Router_Bind':function(){ return Router_Bind;},'set-Router_AttachViewAndPath':function(fun){ var ori=Router_AttachViewAndPath;Router_AttachViewAndPath=fun; return ori;},'get-Router_AttachViewAndPath':function(){ return Router_AttachViewAndPath;},'set-Router_GetChged':function(fun){ var ori=Router_GetChged;Router_GetChged=fun; return ori;},'get-Router_GetChged':function(){ return Router_GetChged;},'set-Router_Parse':function(fun){ var ori=Router_Parse;Router_Parse=fun; return ori;},'get-Router_Parse':function(){ return Router_Parse;},'set-Router_Diff':function(fun){ var ori=Router_Diff;Router_Diff=fun; return ori;},'get-Router_Diff':function(){ return Router_Diff;},'set-Dispatcher_Update':function(fun){ var ori=Dispatcher_Update;Dispatcher_Update=fun; return ori;},'get-Dispatcher_Update':function(){ return Dispatcher_Update;},'set-Dispatcher_NotifyChange':function(fun){ var ori=Dispatcher_NotifyChange;Dispatcher_NotifyChange=fun; return ori;},'get-Dispatcher_NotifyChange':function(){ return Dispatcher_NotifyChange;},'set-Vframe_NotifyCreated':function(fun){ var ori=Vframe_NotifyCreated;Vframe_NotifyCreated=fun; return ori;},'get-Vframe_NotifyCreated':function(){ return Vframe_NotifyCreated;},'set-Vframe_NotifyAlter':function(fun){ var ori=Vframe_NotifyAlter;Vframe_NotifyAlter=fun; return ori;},'get-Vframe_NotifyAlter':function(){ return Vframe_NotifyAlter;},'set-Vframe_TranslateQuery':function(fun){ var ori=Vframe_TranslateQuery;Vframe_TranslateQuery=fun; return ori;},'get-Vframe_TranslateQuery':function(){ return Vframe_TranslateQuery;},'set-Vframe_Root':function(fun){ var ori=Vframe_Root;Vframe_Root=fun; return ori;},'get-Vframe_Root':function(){ return Vframe_Root;},'set-Vframe_AddVframe':function(fun){ var ori=Vframe_AddVframe;Vframe_AddVframe=fun; return ori;},'get-Vframe_AddVframe':function(){ return Vframe_AddVframe;},'set-Vframe_RunInvokes':function(fun){ var ori=Vframe_RunInvokes;Vframe_RunInvokes=fun; return ori;},'get-Vframe_RunInvokes':function(){ return Vframe_RunInvokes;},'set-Vframe_RemoveVframe':function(fun){ var ori=Vframe_RemoveVframe;Vframe_RemoveVframe=fun; return ori;},'get-Vframe_RemoveVframe':function(){ return Vframe_RemoveVframe;},'set-Vframe':function(fun){ var ori=Vframe;Vframe=fun; return ori;},'get-Vframe':function(){ return Vframe;},'set-Body_FindVframeInfo':function(fun){ var ori=Body_FindVframeInfo;Body_FindVframeInfo=fun; return ori;},'get-Body_FindVframeInfo':function(){ return Body_FindVframeInfo;},'set-Body_DOMEventProcessor':function(fun){ var ori=Body_DOMEventProcessor;Body_DOMEventProcessor=fun; return ori;},'get-Body_DOMEventProcessor':function(){ return Body_DOMEventProcessor;},'set-Body_DOMEventBind':function(fun){ var ori=Body_DOMEventBind;Body_DOMEventBind=fun; return ori;},'get-Body_DOMEventBind':function(){ return Body_DOMEventBind;},'set-I_UnmountVframs':function(fun){ var ori=I_UnmountVframs;I_UnmountVframs=fun; return ori;},'get-I_UnmountVframs':function(){ return I_UnmountVframs;},'set-I_GetNode':function(fun){ var ori=I_GetNode;I_GetNode=fun; return ori;},'get-I_GetNode':function(){ return I_GetNode;},'set-I_SetAttributes':function(fun){ var ori=I_SetAttributes;I_SetAttributes=fun; return ori;},'get-I_SetAttributes':function(){ return I_SetAttributes;},'set-I_SpecialDiff':function(fun){ var ori=I_SpecialDiff;I_SpecialDiff=fun; return ori;},'get-I_SpecialDiff':function(){ return I_SpecialDiff;},'set-I_GetCompareKey':function(fun){ var ori=I_GetCompareKey;I_GetCompareKey=fun; return ori;},'get-I_GetCompareKey':function(){ return I_GetCompareKey;},'set-I_SetChildNodes':function(fun){ var ori=I_SetChildNodes;I_SetChildNodes=fun; return ori;},'get-I_SetChildNodes':function(){ return I_SetChildNodes;},'set-I_SetNode':function(fun){ var ori=I_SetNode;I_SetNode=fun; return ori;},'get-I_SetNode':function(){ return I_SetNode;},'set-Updater_Safeguard':function(fun){ var ori=Updater_Safeguard;Updater_Safeguard=fun; return ori;},'get-Updater_Safeguard':function(){ return Updater_Safeguard;},'set-Updater_EncodeReplacer':function(fun){ var ori=Updater_EncodeReplacer;Updater_EncodeReplacer=fun; return ori;},'get-Updater_EncodeReplacer':function(){ return Updater_EncodeReplacer;},'set-Updater_Encode':function(fun){ var ori=Updater_Encode;Updater_Encode=fun; return ori;},'get-Updater_Encode':function(){ return Updater_Encode;},'set-Updater_Ref':function(fun){ var ori=Updater_Ref;Updater_Ref=fun; return ori;},'get-Updater_Ref':function(){ return Updater_Ref;},'set-Updater_URIReplacer':function(fun){ var ori=Updater_URIReplacer;Updater_URIReplacer=fun; return ori;},'get-Updater_URIReplacer':function(){ return Updater_URIReplacer;},'set-Updater_EncodeURI':function(fun){ var ori=Updater_EncodeURI;Updater_EncodeURI=fun; return ori;},'get-Updater_EncodeURI':function(){ return Updater_EncodeURI;},'set-Updater_EncodeQ':function(fun){ var ori=Updater_EncodeQ;Updater_EncodeQ=fun; return ori;},'get-Updater_EncodeQ':function(){ return Updater_EncodeQ;},'set-Updater_Digest':function(fun){ var ori=Updater_Digest;Updater_Digest=fun; return ori;},'get-Updater_Digest':function(){ return Updater_Digest;},'set-Updater':function(fun){ var ori=Updater;Updater=fun; return ori;},'get-Updater':function(){ return Updater;},'set-processMixinsSameEvent':function(fun){ var ori=processMixinsSameEvent;processMixinsSameEvent=fun; return ori;},'get-processMixinsSameEvent':function(){ return processMixinsSameEvent;},'set-View_DestroyAllResources':function(fun){ var ori=View_DestroyAllResources;View_DestroyAllResources=fun; return ori;},'get-View_DestroyAllResources':function(){ return View_DestroyAllResources;},'set-View_DestroyResource':function(fun){ var ori=View_DestroyResource;View_DestroyResource=fun; return ori;},'get-View_DestroyResource':function(){ return View_DestroyResource;},'set-View_WrapMethod':function(fun){ var ori=View_WrapMethod;View_WrapMethod=fun; return ori;},'get-View_WrapMethod':function(){ return View_WrapMethod;},'set-View_DelegateEvents':function(fun){ var ori=View_DelegateEvents;View_DelegateEvents=fun; return ori;},'get-View_DelegateEvents':function(){ return View_DelegateEvents;},'set-View_MergeMixins':function(fun){ var ori=View_MergeMixins;View_MergeMixins=fun; return ori;},'get-View_MergeMixins':function(){ return View_MergeMixins;},'set-merge':function(fun){ var ori=merge;merge=fun; return ori;},'get-merge':function(){ return merge;},'set-extend':function(fun){ var ori=extend;extend=fun; return ori;},'get-extend':function(){ return extend;},'set-View_Prepare':function(fun){ var ori=View_Prepare;View_Prepare=fun; return ori;},'get-View_Prepare':function(){ return View_Prepare;},'set-View_IsObserveChanged':function(fun){ var ori=View_IsObserveChanged;View_IsObserveChanged=fun; return ori;},'get-View_IsObserveChanged':function(){ return View_IsObserveChanged;},'set-View':function(fun){ var ori=View;View=fun; return ori;},'get-View':function(){ return View;},'set-Bag':function(fun){ var ori=Bag;Bag=fun; return ori;},'get-Bag':function(){ return Bag;},'set-Service_CacheDone':function(fun){ var ori=Service_CacheDone;Service_CacheDone=fun; return ori;},'get-Service_CacheDone':function(){ return Service_CacheDone;},'set-Service_Task':function(fun){ var ori=Service_Task;Service_Task=fun; return ori;},'get-Service_Task':function(){ return Service_Task;},'set-Service_Send':function(fun){ var ori=Service_Send;Service_Send=fun; return ori;},'get-Service_Send':function(){ return Service_Send;},'set-Service':function(fun){ var ori=Service;Service=fun; return ori;},'get-Service':function(){ return Service;},'set-Manager_DefaultCacheKey':function(fun){ var ori=Manager_DefaultCacheKey;Manager_DefaultCacheKey=fun; return ori;},'get-Manager_DefaultCacheKey':function(){ return Manager_DefaultCacheKey;},'set-Manager_ClearCache':function(fun){ var ori=Manager_ClearCache;Manager_ClearCache=fun; return ori;},'get-Manager_ClearCache':function(){ return Manager_ClearCache;}};
    Magix['$|_attrForTest_|$priVar$|_attrForTest_|$']={'get-$':function(){ return $;},'set-$':function(value){ $ = value;},'get-G_IsObject':function(){ return G_IsObject;},'set-G_IsObject':function(value){ G_IsObject = value;},'get-G_IsArray':function(){ return G_IsArray;},'set-G_IsArray':function(value){ G_IsArray = value;},'get-G_COUNTER':function(){ return G_COUNTER;},'set-G_COUNTER':function(value){ G_COUNTER = value;},'get-G_EMPTY':function(){ return G_EMPTY;},'set-G_EMPTY':function(value){ G_EMPTY = value;},'get-G_EMPTY_ARRAY':function(){ return G_EMPTY_ARRAY;},'set-G_EMPTY_ARRAY':function(value){ G_EMPTY_ARRAY = value;},'get-G_COMMA':function(){ return G_COMMA;},'set-G_COMMA':function(value){ G_COMMA = value;},'get-G_NULL':function(){ return G_NULL;},'set-G_NULL':function(value){ G_NULL = value;},'get-G_WINDOW':function(){ return G_WINDOW;},'set-G_WINDOW':function(value){ G_WINDOW = value;},'get-G_Undefined':function(){ return G_Undefined;},'set-G_Undefined':function(value){ G_Undefined = value;},'get-G_DOCUMENT':function(){ return G_DOCUMENT;},'set-G_DOCUMENT':function(value){ G_DOCUMENT = value;},'get-GA':function(){ return GA;},'set-GA':function(value){ GA = value;},'get-G_DOC':function(){ return G_DOC;},'set-G_DOC':function(value){ G_DOC = value;},'get-Timeout':function(){ return Timeout;},'set-Timeout':function(value){ Timeout = value;},'get-G_CHANGED':function(){ return G_CHANGED;},'set-G_CHANGED':function(value){ G_CHANGED = value;},'get-G_CHANGE':function(){ return G_CHANGE;},'set-G_CHANGE':function(value){ G_CHANGE = value;},'get-G_PAGE_UNLOAD':function(){ return G_PAGE_UNLOAD;},'set-G_PAGE_UNLOAD':function(value){ G_PAGE_UNLOAD = value;},'get-G_VALUE':function(){ return G_VALUE;},'set-G_VALUE':function(value){ G_VALUE = value;},'get-G_Tag_Key':function(){ return G_Tag_Key;},'set-G_Tag_Key':function(value){ G_Tag_Key = value;},'get-G_Tag_Attr_Key':function(){ return G_Tag_Attr_Key;},'set-G_Tag_Attr_Key':function(value){ G_Tag_Attr_Key = value;},'get-G_Tag_View_Key':function(){ return G_Tag_View_Key;},'set-G_Tag_View_Key':function(value){ G_Tag_View_Key = value;},'get-G_HashKey':function(){ return G_HashKey;},'set-G_HashKey':function(value){ G_HashKey = value;},'get-JSONStringify':function(){ return JSONStringify;},'set-JSONStringify':function(value){ JSONStringify = value;},'get-G_DOCBODY':function(){ return G_DOCBODY;},'set-G_DOCBODY':function(value){ G_DOCBODY = value;},'get-G_SPLITER':function(){ return G_SPLITER;},'set-G_SPLITER':function(value){ G_SPLITER = value;},'get-Magix_StrObject':function(){ return Magix_StrObject;},'set-Magix_StrObject':function(value){ Magix_StrObject = value;},'get-G_PROTOTYPE':function(){ return G_PROTOTYPE;},'set-G_PROTOTYPE':function(value){ G_PROTOTYPE = value;},'get-G_PARAMS':function(){ return G_PARAMS;},'set-G_PARAMS':function(value){ G_PARAMS = value;},'get-G_PATH':function(){ return G_PATH;},'set-G_PATH':function(value){ G_PATH = value;},'get-G_MX_VIEW':function(){ return G_MX_VIEW;},'set-G_MX_VIEW':function(value){ G_MX_VIEW = value;},'get-Magix_PathTrimParamsReg':function(){ return Magix_PathTrimParamsReg;},'set-Magix_PathTrimParamsReg':function(value){ Magix_PathTrimParamsReg = value;},'get-Magix_ParamsReg':function(){ return Magix_ParamsReg;},'set-Magix_ParamsReg':function(value){ Magix_ParamsReg = value;},'get-Magix_IsParam':function(){ return Magix_IsParam;},'set-Magix_IsParam':function(value){ Magix_IsParam = value;},'get-MxGlobalView':function(){ return MxGlobalView;},'set-MxGlobalView':function(value){ MxGlobalView = value;},'get-Magix_Cfg':function(){ return Magix_Cfg;},'set-Magix_Cfg':function(value){ Magix_Cfg = value;},'get-Magix_HasProp':function(){ return Magix_HasProp;},'set-Magix_HasProp':function(value){ Magix_HasProp = value;},'get-Header':function(){ return Header;},'set-Header':function(value){ Header = value;},'get-G_Extend':function(){ return G_Extend;},'set-G_Extend':function(value){ G_Extend = value;},'get-G_TargetMatchSelector':function(){ return G_TargetMatchSelector;},'set-G_TargetMatchSelector':function(value){ G_TargetMatchSelector = value;},'get-Magix_PathToObjCache':function(){ return Magix_PathToObjCache;},'set-Magix_PathToObjCache':function(value){ Magix_PathToObjCache = value;},'get-Magix_Booted':function(){ return Magix_Booted;},'set-Magix_Booted':function(value){ Magix_Booted = value;},'get-Magix_ParamsObjectTemp':function(){ return Magix_ParamsObjectTemp;},'set-Magix_ParamsObjectTemp':function(value){ Magix_ParamsObjectTemp = value;},'get-G_ParseCache':function(){ return G_ParseCache;},'set-G_ParseCache':function(value){ G_ParseCache = value;},'get-CallIndex':function(){ return CallIndex;},'set-CallIndex':function(value){ CallIndex = value;},'get-CallList':function(){ return CallList;},'set-CallList':function(value){ CallList = value;},'get-CallBreakTime':function(){ return CallBreakTime;},'set-CallBreakTime':function(value){ CallBreakTime = value;},'get-EventDefaultOptions':function(){ return EventDefaultOptions;},'set-EventDefaultOptions':function(value){ EventDefaultOptions = value;},'get-Magix':function(){ return Magix;},'set-Magix':function(value){ Magix = value;},'get-MEvent':function(){ return MEvent;},'set-MEvent':function(value){ MEvent = value;},'get-State_AppData':function(){ return State_AppData;},'set-State_AppData':function(value){ State_AppData = value;},'get-State_AppDataKeyRef':function(){ return State_AppDataKeyRef;},'set-State_AppDataKeyRef':function(value){ State_AppDataKeyRef = value;},'get-State_ChangedKeys':function(){ return State_ChangedKeys;},'set-State_ChangedKeys':function(value){ State_ChangedKeys = value;},'get-State_DataIsChanged':function(){ return State_DataIsChanged;},'set-State_DataIsChanged':function(value){ State_DataIsChanged = value;},'get-State_DataWhereSet':function(){ return State_DataWhereSet;},'set-State_DataWhereSet':function(value){ State_DataWhereSet = value;},'get-State':function(){ return State;},'set-State':function(value){ State = value;},'get-Router_VIEW':function(){ return Router_VIEW;},'set-Router_VIEW':function(value){ Router_VIEW = value;},'get-Router_HrefCache':function(){ return Router_HrefCache;},'set-Router_HrefCache':function(value){ Router_HrefCache = value;},'get-Router_ChgdCache':function(){ return Router_ChgdCache;},'set-Router_ChgdCache':function(value){ Router_ChgdCache = value;},'get-Router_WinLoc':function(){ return Router_WinLoc;},'set-Router_WinLoc':function(value){ Router_WinLoc = value;},'get-Router_LastChanged':function(){ return Router_LastChanged;},'set-Router_LastChanged':function(value){ Router_LastChanged = value;},'get-Router_Silent':function(){ return Router_Silent;},'set-Router_Silent':function(value){ Router_Silent = value;},'get-Router_LLoc':function(){ return Router_LLoc;},'set-Router_LLoc':function(value){ Router_LLoc = value;},'get-Router_TrimHashReg':function(){ return Router_TrimHashReg;},'set-Router_TrimHashReg':function(value){ Router_TrimHashReg = value;},'get-Router_TrimQueryReg':function(){ return Router_TrimQueryReg;},'set-Router_TrimQueryReg':function(value){ Router_TrimQueryReg = value;},'get-Router_Edge':function(){ return Router_Edge;},'set-Router_Edge':function(value){ Router_Edge = value;},'get-Router_Hashbang':function(){ return Router_Hashbang;},'set-Router_Hashbang':function(value){ Router_Hashbang = value;},'get-Router_PNR_Routers':function(){ return Router_PNR_Routers;},'set-Router_PNR_Routers':function(value){ Router_PNR_Routers = value;},'get-Router_PNR_Rewrite':function(){ return Router_PNR_Rewrite;},'set-Router_PNR_Rewrite':function(value){ Router_PNR_Rewrite = value;},'get-DefaultTitle':function(){ return DefaultTitle;},'set-DefaultTitle':function(value){ DefaultTitle = value;},'get-Router':function(){ return Router;},'set-Router':function(value){ Router = value;},'get-Dispatcher_UpdateTag':function(){ return Dispatcher_UpdateTag;},'set-Dispatcher_UpdateTag':function(value){ Dispatcher_UpdateTag = value;},'get-Vframe_RootVframe':function(){ return Vframe_RootVframe;},'set-Vframe_RootVframe':function(value){ Vframe_RootVframe = value;},'get-Vframe_GlobalAlter':function(){ return Vframe_GlobalAlter;},'set-Vframe_GlobalAlter':function(value){ Vframe_GlobalAlter = value;},'get-Vframe_Vframes':function(){ return Vframe_Vframes;},'set-Vframe_Vframes':function(value){ Vframe_Vframes = value;},'get-Vframe_Promise':function(){ return Vframe_Promise;},'set-Vframe_Promise':function(value){ Vframe_Promise = value;},'get-Vframe_Cache':function(){ return Vframe_Cache;},'set-Vframe_Cache':function(value){ Vframe_Cache = value;},'get-Body_EvtInfoCache':function(){ return Body_EvtInfoCache;},'set-Body_EvtInfoCache':function(value){ Body_EvtInfoCache = value;},'get-Body_EvtInfoReg':function(){ return Body_EvtInfoReg;},'set-Body_EvtInfoReg':function(value){ Body_EvtInfoReg = value;},'get-Body_RootEvents':function(){ return Body_RootEvents;},'set-Body_RootEvents':function(value){ Body_RootEvents = value;},'get-Body_SearchSelectorEvents':function(){ return Body_SearchSelectorEvents;},'set-Body_SearchSelectorEvents':function(value){ Body_SearchSelectorEvents = value;},'get-Body_RangeEvents':function(){ return Body_RangeEvents;},'set-Body_RangeEvents':function(value){ Body_RangeEvents = value;},'get-Body_RangeVframes':function(){ return Body_RangeVframes;},'set-Body_RangeVframes':function(value){ Body_RangeVframes = value;},'get-Body_Guid':function(){ return Body_Guid;},'set-Body_Guid':function(value){ Body_Guid = value;},'get-I_SVGNS':function(){ return I_SVGNS;},'set-I_SVGNS':function(value){ I_SVGNS = value;},'get-I_MATHNS':function(){ return I_MATHNS;},'set-I_MATHNS':function(value){ I_MATHNS = value;},'get-I_WrapMap':function(){ return I_WrapMap;},'set-I_WrapMap':function(value){ I_WrapMap = value;},'get-I_RTagName':function(){ return I_RTagName;},'set-I_RTagName':function(value){ I_RTagName = value;},'get-I_Doc':function(){ return I_Doc;},'set-I_Doc':function(value){ I_Doc = value;},'get-I_Base':function(){ return I_Base;},'set-I_Base':function(value){ I_Base = value;},'get-I_Specials':function(){ return I_Specials;},'set-I_Specials':function(value){ I_Specials = value;},'get-Updater_EM':function(){ return Updater_EM;},'set-Updater_EM':function(value){ Updater_EM = value;},'get-Updater_ER':function(){ return Updater_ER;},'set-Updater_ER':function(value){ Updater_ER = value;},'get-Updater_UM':function(){ return Updater_UM;},'set-Updater_UM':function(value){ Updater_UM = value;},'get-Updater_URIReg':function(){ return Updater_URIReg;},'set-Updater_URIReg':function(value){ Updater_URIReg = value;},'get-Updater_QR':function(){ return Updater_QR;},'set-Updater_QR':function(value){ Updater_QR = value;},'get-View_EvtMethodReg':function(){ return View_EvtMethodReg;},'set-View_EvtMethodReg':function(value){ View_EvtMethodReg = value;},'get-View_Globals':function(){ return View_Globals;},'set-View_Globals':function(value){ View_Globals = value;},'get-G_Type':function(){ return G_Type;},'set-G_Type':function(value){ G_Type = value;},'get-G_Now':function(){ return G_Now;},'set-G_Now':function(value){ G_Now = value;},'get-Service_FetchFlags_ONE':function(){ return Service_FetchFlags_ONE;},'set-Service_FetchFlags_ONE':function(value){ Service_FetchFlags_ONE = value;},'get-Service_FetchFlags_ALL':function(){ return Service_FetchFlags_ALL;},'set-Service_FetchFlags_ALL':function(value){ Service_FetchFlags_ALL = value;},'get-Service_Manager':function(){ return Service_Manager;},'set-Service_Manager':function(value){ Service_Manager = value;}};
    return Magix;
}, {
